...
func newUser(db *gorm.DB) user {
	...
	_user.Last_ = field.NewString(tableName, "Last")
	_user.CreateDate = field.NewTime(tableName, "CreateDate")
	_user.CreateBy = field.NewString(tableName, "CreateBy")
	_user.UpdateDate = field.NewTime(tableName, "UpdateDate")
	_user.UpdateBy = field.NewString(tableName, "UpdateBy")
	_user.IsActive = field.NewBool(tableName, "IsActive")
	_user.AddressID = field.NewString(tableName, "AddressId")
...
func (u *user) updateTableName(table string) *user {
	...
	u.Last_ = field.NewString(table, "Last")
	u.CreateDate = field.NewTime(table, "CreateDate")
	u.CreateBy = field.NewString(table, "CreateBy")
	u.UpdateDate = field.NewTime(table, "UpdateDate")
	u.UpdateBy = field.NewString(table, "UpdateBy")
	u.IsActive = field.NewBool(table, "IsActive")
	u.AddressID = field.NewString(table, "AddressId")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["Last"] = u.Last_
	u.fieldMap["CreateDate"] = u.CreateDate
	u.fieldMap["CreateBy"] = u.CreateBy
	u.fieldMap["UpdateDate"] = u.UpdateDate
	u.fieldMap["UpdateBy"] = u.UpdateBy
	u.fieldMap["IsActive"] = u.IsActive
	u.fieldMap["AddressId"] = u.AddressID
}
